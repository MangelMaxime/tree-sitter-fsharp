...
/// Writes queries/signature/*.scm, queries/nvim/signature/*.scm and queries/zed/signature/*.scm:
/// every pattern of the Helix, Neovim and Zed query files whose node types exist in the
/// signature grammar.
